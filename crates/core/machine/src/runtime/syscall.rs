...
pub enum SyscallCode {
    ...
    BN254_SCALAR_MUL = 0x00_01_01_30,
    /// Execute the `BN254_SCALAR_MAC` precompile.
    BN254_SCALAR_MAC = 0x00_01_01_31,
    /// Execute the `MEMCPY_32` precompile.
    MEMCPY_32 = 0x00_00_01_33,
    /// Execute the `MEMCPY_64` precompile.
    MEMCPY_64 = 0x00_00_01_34,
}
...
impl SyscallCode {
    ...
    pub fn from_u32(value: u32) -> Self {
        match value {
            ...
            0x00_01_01_30 => SyscallCode::BN254_SCALAR_MUL,
            0x00_01_01_31 => SyscallCode::BN254_SCALAR_MAC,
            0x00_00_01_33 => SyscallCode::MEMCPY_32,
            0x00_00_01_34 => SyscallCode::MEMCPY_64,
